Feature: actiTime Webpage Functionalities
  ...
  I want to perform various tasks such as managing tasks, tracking time, generating reports, and managing users.
  So that I can effectively use the system for project and team management.
  ...
  Scenario: Add a new user to the system
    ...
    And I enter the user's details such as "Name", "Email", and "Role"
    And I click "Save"
  ...
  Scenario: Update an existing user's role
    ...
    And I update the user's role to "Manager"
    And I click "Save"
    Then the changes should be reflected in the user's details
